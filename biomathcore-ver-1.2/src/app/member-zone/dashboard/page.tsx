...
export default function DashboardPage() {
  ...
  return (
    <div className="p-6 space-y-6">
        <SectionHeader title="Dashboard" desc="Overview of your activity." />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card>
          ...
          <CardBody><div className="text-5xl font-bold tabular-nums">{data.ai}</div></CardBody>
        </Card>

        <Card>
          <CardHeader><CardTitle>Voice</CardTitle></CardHeader>
          <CardBody><div className="text-5xl font-bold tabular-nums">{data.voice}</div></CardBody>
        </Card>

        <Card>
          <CardHeader><CardTitle>Drug–Gene</CardTitle></CardHeader>
          <CardBody><div className="text-5xl font-bold tabular-nums">{data.dg}</div></CardBody>
        </Card>
      </div>
    </div>
  );
