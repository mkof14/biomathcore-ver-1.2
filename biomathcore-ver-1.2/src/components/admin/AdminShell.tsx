  ...
  const groups = [
    {
      title: "Core",
      items: [
        { href: "/admin", label: "Dashboard", hint: "   " },
        { href: "/admin/env", label: "Environment Health", hint: "  " },
        { href: "/admin/secrets", label: "Secrets", hint: " API-  " },
      ],
    },
    {
      title: "Integrations",
      items: [
        { href: "/admin/integrations", label: "Integrations", hint: " Stripe, Gemini  ." },
        { href: "/admin/providers", label: "OAuth Providers", hint: "Apple / Google / Microsoft / Facebook" },
        { href: "/admin/email", label: "Email / Magic Link", hint: "SMTP  Magic Link" },
        { href: "/admin/payments", label: "Payments", hint: "Stripe " },
      ],
    },
    {
      title: "Ops",
      items: [
        { href: "/admin/flags", label: "Feature Flags", hint: "  " },
        { href: "/admin/logs", label: "Audit Logs", hint: " " },
        { href: "/admin/backups", label: "Backups", hint: "Export .env  secrets" },
        { href: "/admin/status", label: "System Status", hint: "  " },
      ],
    },
  ];
