...
export default function AboutPage() {
  const categories: { name: string; color: string }[] = [
    ...
    { name: "Longevity & Anti-Aging", color: "from-[#0d2f2b] to-[#0a1c1a]" },
    ...
    { name: "Beauty & Skincare", color: "from-[#4a0e1e] to-[#2a0b13]" },
    { name: "Nutrition & Diet", color: "from-[#263a0d] to-[#151f0a]" },
    { name: "Sleep & Recovery", color: "from-[#2d184a] to-[#170e2a]" },
    { name: "Environmental Health", color: "from-[#103426] to-[#0c1f18]" },
    ...
    { name: "General Sexual Longevity", color: "from-[#3a0d3f] to-[#220825]" },
    { name: "Men's Sexual Health", color: "from-[#171c4a] to-[#0e1130]" },
    { name: "Women's Sexual Health", color: "from-[#4a1030] to-[#2a0c1d]" },
    {
