  ...
  return (
    <div className="legal-content text-gray-900 dark:text-gray-100 leading-relaxed">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <h2 className="text-2xl font-bold mb-4">Notice of HIPAA Privacy Practices</h2>
        ...
        <p className="mb-4">This Notice describes how medical information about you may be used and disclosed and how you can access this information. Please review it carefully.</p>
        <h3 className="text-xl font-semibold mt-8 mb-2">How We May Use and Disclose Your PHI</h3>
        <ul className="list-disc ml-6 mb-4 space-y-1">
          <li><b>Treatment</b> — to provide you with healthcare services</li>
          <li><b>Payment</b> — to bill for and receive payment for services</li>
          <li><b>Operations</b> — to support quality care and service improvements</li>
        </ul>
        ...
        <p className="text-sm text-gray-900 mt-8">This is a demo page. The full HIPAA Notice will be available in the actual version of the site.</p>
      </div>
    </div>
  );
}
