...
export default function PrivacyPolicyPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <p className="mb-4">
        At BioMath Core (“we”, “us”, or “our”), we take your privacy seriously.
        This Privacy Policy explains how we collect, use, disclose, and
        safeguard your information when you visit our website and use our
        services (“Service”). By using our Service, you agree to the collection
      ...
      <p className="mb-4">
        ...
        (“Usage Data”), including IP address, browser type and version, pages
      ...
      <h3 className="text-xl font-semibold mt-8 mb-2">Transfer of Data</h3>
      <p className="mb-4">
        Your information, including Personal Data, may be transferred to — and
        maintained on — computers located outside of your state, province, or
        country where the data protection laws may differ. We will take all
        steps reasonably necessary to ensure that your data is treated securely
        and in accordance with this Privacy Policy.
      </p>

      <h3 className="text-xl font-semibold mt-8 mb-2">Disclosure of Data</h3>
      <p className="mb-4">
        We may disclose Personal Data in the good faith belief that such action
        is necessary to:
      </p>
      <ul className="list-disc ml-6 mb-4 space-y-1">
        <li>Comply with a legal obligation</li>
        <li>Protect and defend the rights or property of BioMath Core</li>
        <li>
      ...
      <h3 className="text-xl font-semibold mt-8 mb-2">Security of Data</h3>
      <p className="mb-4">
      ...
      <ul className="list-disc ml-6 mb-4 space-y-1">
        ...
        <li>Rectification and data portability where applicable</li>
      ...
      <p className="mb-4">
        ...
        at{" "}
        <Link
          href="mailto:legal@biomathcore.com"
          className="text-blue-600 underline"
        >
          legal@biomathcore.com
        </Link>
        .
      </p>

      <p className="text-sm text-gray-600 mt-8">
        This is a demo page. The full Privacy Policy will be available in the
